            ...
            <div class="col-lg-8 col-sm-12">
                <div class="row">
                    <div class="col-lg-12 col-sm-12 shadow-sm p-4">
                        ...
                        <div>
                            <h5 class="mb-3 h4" style="color:#f1671e!important">
                                <i class="fa fa-calendar-day me-2"></i>Day 1: Umbwe Gate to Cave Bivouac Camp
                            </h5>
                    ...
                    <div class="col-lg-12 col-sm-12 shadow-sm p-4">
                        ...
                        <div>
                            <h5 class="mb-3 h4" style="color:#f1671e!important">
                                <i class="fa fa-calendar-day me-2"></i>Day 2: Cave Bivouac to Barranco Camp
                            </h5>
                            <span style="text-align: justify">
                    ...
                    <div class="col-lg-12 col-sm-12 shadow-sm p-4">
                        ...
                        <div>
                            <h5 class="mb-3 h4" style="color:#f1671e!important">
                                <i class="fa fa-calendar-day me-2"></i>Day 3: Barranco Camp to Karanga Valley 
                            </h5>
                            <span style="text-align: justify">
                    ...
                    <div class="col-lg-12 col-sm-12 shadow-sm p-4">
                        ...
                        <div>
                            <h5 class="mb-3 h4" style="color:#f1671e!important">
                                <i class="fa fa-calendar-day me-2"></i>Day 4: Barafu Camp to Mweka Camp
                            </h5>
                            <span style="text-align: justify">
                    ...
                    <div class="col-lg-12 col-sm-12 shadow-sm p-4">
                        ...
                        <div>
                            <h5 class="mb-3 h4" style="color:#f1671e!important">
                                <i class="fa fa-calendar-day me-2"></i>Day 5: Barafu Camp  to Uhuru Peak to Mweka Camp
                            </h5>
                            <span style="text-align: justify">
