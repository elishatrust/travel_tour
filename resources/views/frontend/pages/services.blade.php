  ...
  <div class="container">
      <div class="row g-5 mb-5 wow123 fadeInUp" data-wow123-delay="0.1s">
          <div class="col-lg-6">
              ...
              <h1 class="display-5 mb-0" style="">
                  Special Services For
                  <span style="color:#0059c5!important">UPZONE</span><span class="text-primary">Safaris</span> Visitors
              </h1>
          </div>
          <div class="col-lg-6">
      ...
      <div class="row gy-5 gx-4">
          <div
          class="col-lg-3 col-md-4 col-sm-6 wow123 fadeInUp"
