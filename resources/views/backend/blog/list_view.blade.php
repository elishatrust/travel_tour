            ...
            <div class="single_post">
                <div class="img-post m-b-5">
                    @if ($item->file_path && file_exists(public_path($item->file_path)))
                        <img src="{{ asset($item->file_path) }}" class="w-100" style="border-radius:10px;height:300px; object-fit:cover;" alt="UpzoneSafari">
                    @else
                        <img src="{{ asset('assets/frontend/img/safari/12.jpg') }}" class="w-100" style="border-radius:10px;height:300px; object-fit:cover;" alt="UpzoneSafari">
                    @endif
                </div>
