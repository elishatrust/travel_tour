    ...
    <div class="row g-5">
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="display-5 mb-4">
                About <span class="text-primary">GoTrip</span>
            </h1>
...
<div class="container-xxl py-5">
    ...
    <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
        ...
        <h1 class="display-5 mb-0">
            Let`s See Our <span class="text-primary">GoTrip</span> Awesome
            Animals
        </h1>
        </div>
    ...
    <div class="container">
        <div class="row g-5 mb-5 align-items-end wow fadeInUp" data-wow-delay="0.1s">
            <div class="col-lg-6">
                ...
                <h1 class="display-5 mb-0">You Can Be A Proud Member Of <span class="text-primary">GoTrip</span></h1>
            </div>
            <div class="col-lg-6 text-lg-end">
		...
		<div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s">
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12  wow fadeInUp" data-wow-delay="0.3s">
					<hr class=" border-bottom border-primary"><h4 class="text-start">Follow <strong>@gotripcompanyltd</strong> on Social Media </h4><hr class=" border-bottom border-primary">
				</div>
