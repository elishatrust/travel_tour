...
<div class="container-xxl py-5">
    ...
    <div class="row g-4">
        ...
        <div class="row g-4">
            ...
            <a
                class="animal-item"
                href="{{ asset('assets/frontend/img/animal-lg-1.jpg') }}"
                data-lightbox="animal"
            >
                <div class="position-relative">
        ...
        <div class="row g-4">
            ...
            <a
                class="animal-item"
                href="{{ asset('assets/frontend/img/animal-lg-2.jpg') }}"
                data-lightbox="animal"
            >
                <div class="position-relative">
            ...
            <a
                class="animal-item"
                href="{{ asset('assets/frontend/img/animal-md-2.jpg') }}"
                data-lightbox="animal"
            >
                <div class="position-relative">
        ...
        <div class="row g-4">
            ...
            <a
                class="animal-item"
                href="{{ asset('assets/frontend/img/animal-md-3.jpg') }}"
                data-lightbox="animal"
            >
                <div class="position-relative">
            ...
            <a
                class="animal-item"
                href="{{ asset('assets/frontend/img/animal-lg-3.jpg') }}"
                data-lightbox="animal"
            >
                <div class="position-relative">
